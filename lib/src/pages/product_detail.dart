...
class _ProductDetailPageState extends State<ProductDetailPage> with TickerProviderStateMixin {
  ...
  Widget _icon(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
            color: LightColor.iconColor, style: isOutLine ? BorderStyle.solid : BorderStyle.none),
        borderRadius: BorderRadius.all(Radius.circular(13)),
        color: isOutLine ? Colors.transparent : Theme.of(context).backgroundColor,
        boxShadow: <BoxShadow>[
          BoxShadow(
              color: Color(0xfff8f8f8), blurRadius: 5, spreadRadius: 10, offset: Offset(5, 5)),
        ],
      ),
  ...
  Widget _sizeWidget(String text, {bool isSelected = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
            color: LightColor.iconColor, style: !isSelected ? BorderStyle.solid : BorderStyle.none),
        borderRadius: BorderRadius.all(Radius.circular(13)),
        color: isSelected ? LightColor.green : Theme.of(context).backgroundColor,
      ),
      child: TitleText(
        text: text,
        fontSize: 16,
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            ...
            _colorWidget(LightColor.lightGreen),
            SizedBox(
              width: 30,
            ),
